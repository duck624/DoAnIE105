...
def parser_args():
    ...
    # =========================== Other parameters ===================================
    parser.add_argument('--device', type=str, default='cpu', help='Device to use (cpu or cuda)')  # Thêm dòng này
    parser.add_argument('--gpu', type=str, default=None, help='GPU ID (None for CPU)')  # Sửa dòng này
